...
if y_offset = 1{
	...
	scr_draw_outline(x,y+50,"A and D or arrows to move",c_white,obj_control.dark,1)
	scr_draw_outline(x,y+65,"Space W or up arrow to jump",c_white,obj_control.dark,1)
	scr_draw_outline(x,y+80,"S E or down arrow to grab blocks with your tail",c_white,obj_control.dark,1)
